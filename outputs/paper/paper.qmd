...
The Police Annual Statistical Report - Homicides [@citehomicidedata] from [@ropendatatoronto] provides a record of all homicide cases in Toronto from 2004-2020 including the time of occurrence, location, and type of homicide. we could draw information about homicide cases and their related characteristics from this extensive dataset, and investigate Toronto’s homicide patterns across time. In Section 2, I introduce the dataset and some general information. In Section 2.1 ## General Homicide Analysis, I navigate the change in homicide case numbers across time with various characteristics and perform some analysis on the relationship between homicide cases and time variables. And in Section 2.2, I redo most of the analysis on the top five neighborhood with the most amount of homicide cases. Lastly, I discuss the implications and further discussions on these results in Section 3. 
...
```
## Homicide Analysis in Top Five Neighborhood
